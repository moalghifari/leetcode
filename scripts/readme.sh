...
FILETYPE_LOWER=`echo "$FILETYPE" | awk '{print tolower($0)}'`
FILE=`echo ${FILE} | sed "s/.*\/$FILETYPE_LOWER/\.\/$FILETYPE_LOWER/"`

echo "|${QUESTION_FRONTEND_ID}|[${QUESTION_TITLE}](${URL}) | [$FILETYPE](${FILE})|${QUESTION_DIFFICULTY}|"
