...
# the value of the i^th token (0-indexed).
# 
# Your goal is to maximize your total score by potentially playing each token in one of two ways:
# 
# 	If your current power is at least tokens[i], you may play the i^th token face up, losing 
# tokens[i] power and gaining 1 score.
# 	If your current score is at least 1, you may play the i^th token face down, gaining 
...
# Output: 0
# Explanation: Playing the only token in the bag is impossible because you either have too little 
